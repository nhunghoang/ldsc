...
class LDSCconfig(ParserConfig):
    ...
    def _add_subparsers(parser: argparse.ArgumentParser, parent: list[argparse.ArgumentParser]) -> None:
        ...
        ldscore_parser.add_argument(
            "--bfile", default=None, type=str, help="Prefix for Plink .bed/.bim/.fam file", required=True
        )
        ...
        annot_extract_group = ldscore_parser.add_mutually_exclusive_group(required=False)
        ...
        per_allele_pq_exp_group = ldscore_parser.add_mutually_exclusive_group(required=False)
